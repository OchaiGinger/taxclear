...
export const CTA = () => {
  return (
    <section className="relative py-[20vh] bg-brand-black flex flex-col items-center justify-center text-center px-6 overflow-hidden border-t border-white/5">
      <div className="absolute inset-0 z-0 opacity-10 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-brand-green/40 via-transparent to-transparent" />
